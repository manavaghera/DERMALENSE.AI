...
export default function WorkflowSection() {
  ...
  return (
    <section id="workflow" className="relative overflow-hidden bg-[#102d2a] text-white">
      <span className="absolute top-6 left-10 font-display text-[clamp(5rem,12vw,10rem)] font-bold leading-none opacity-[0.06] pointer-events-none select-none text-[#a8d6bd] rotate-[-6deg]">05</span>
