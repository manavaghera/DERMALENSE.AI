...
export default function WorkflowSection() {
  ...
  return (
    <section id="workflow" className="relative overflow-hidden bg-[#102d2a] text-white">
      <span className="absolute bottom-2 left-4 font-display text-[clamp(3rem,8vw,6rem)] font-bold leading-none opacity-20 pointer-events-none select-none text-[#f16f61]">05</span>
