...
export default function DatasetsSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#102d2a] via-[#0e2a27] to-[#102d2a] text-white">
      <span className="absolute bottom-4 right-12 font-display text-[clamp(5rem,12vw,10rem)] font-bold leading-none opacity-[0.06] pointer-events-none select-none text-[#087f59] rotate-[-12deg]">07</span>
