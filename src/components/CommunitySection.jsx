...
export default function CommunitySection() {
  return (
    <section id="community" className="relative overflow-hidden bg-gradient-to-br from-[#102d2a] via-[#123e70] to-[#102d2a] text-white">
      <span className="absolute top-1/2 -translate-y-1/2 right-8 font-display text-[clamp(5rem,12vw,10rem)] font-bold leading-none opacity-20 pointer-events-none select-none text-[#f16f61] rotate-[5deg]">03</span>
      <div className="mx-auto max-w-[1320px] px-7 py-14 lg:px-10">
        <div className="grid grid-cols-12 items-end gap-8">
          <div className="col-span-12 lg:col-span-5">
            ...
            <h2 className="mt-4 font-display text-[clamp(1.75rem,6vw,2.7rem)] leading-[1.04] tracking-[-.04em]">
              Technology that
              <br />
              <span className="text-[#a8d6bd]">meets people.</span>
            </h2>
          </div>
          <p className="col-span-12 max-w-full text-sm leading-7 text-white/65 lg:col-span-4 lg:col-start-8 lg:max-w-[430px]">
        ...
        {/* Cards */}
        <div className="mt-10 grid grid-cols-1 gap-px overflow-hidden border border-white/15 bg-white/15 sm:grid-cols-2 md:mt-12 md:grid-cols-3">
