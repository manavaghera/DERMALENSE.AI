...
export default function CommunitySection() {
  return (
    <section id="community" className="relative overflow-hidden bg-gradient-to-br from-[#102d2a] via-[#123e70] to-[#102d2a] text-white">
      <span className="absolute bottom-2 left-4 font-display text-[clamp(3rem,8vw,6rem)] font-bold leading-none opacity-[0.1] pointer-events-none select-none text-[#f16f61]">03</span>
