...
export default function CommunitySection() {
  return (
    <section id="community" className="relative overflow-hidden bg-gradient-to-br from-[#102d2a] via-[#123e70] to-[#102d2a] text-white">
      <span className="absolute top-1/2 -translate-y-1/2 right-8 font-display text-[100px] font-bold leading-none pointer-events-none select-none text-[#f16f61] rotate-[5deg]">03</span>
